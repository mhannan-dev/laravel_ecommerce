    ...
    <div class="row">
        <div id="gallery" class="span3">
            <a href="{{ URL::asset('backend') }}/themes/images/products/large/f1.jpg" title="Blue Casual T-Shirt">
                <img src="{{ URL::asset('backend') }}/themes/images/products/large/3.jpg" style="width:100%" alt="Blue Casual T-Shirt">
            </a>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="blockView">
                        <ul class="thumbnails">
                            <li class="span3">
                                <div class="thumbnail">
                                    <a href="product_details.html"><img src="{{ URL::asset('backend') }}/themes/images/products/10.jpg" alt=""></a>
                                    <div class="caption">
                            ...
                            <li class="span3">
                                <div class="thumbnail">
                                    <a href="product_details.html"><img src="{{ URL::asset('backend') }}/themes/images/products/11.jpg" alt=""></a>
                                    <div class="caption">
                                        <h5>Casual T-Shirt</h5>
                                        <p>
                                            Lorem Ipsum is simply dummy text.
                            ...
                            <li class="span3">
                                <div class="thumbnail">
                                    <a href="product_details.html"><img src="{{ URL::asset('backend') }}/themes/images/products/12.jpg" alt=""></a>
                                    <div class="caption">
                                        <h5>Casual T-Shirt</h5>
                                        <p>
                                            Lorem Ipsum is simply dummy text.
                            ...
                            <li class="span3">
                                <div class="thumbnail">
                                    <a href="product_details.html"><img src="{{ URL::asset('backend') }}/themes/images/products/13.jpg" alt=""></a>
                                    <div class="caption">
                                        <h5>Casual T-Shirt</h5>
                                        <p>
                                            Lorem Ipsum is simply dummy text.
                            ...
                            <li class="span3">
                                <div class="thumbnail">
                                    <a href="product_details.html"><img src="{{ URL::asset('backend') }}/themes/images/products/1.jpg" alt=""></a>
                                    <div class="caption">
                                        <h5>Casual T-Shirt</h5>
                                        <p>
                                            Lorem Ipsum is simply dummy text.
