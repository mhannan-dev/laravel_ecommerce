...
<div class="span9">
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('/'.$product_details['category']['slug']) }}">{{ $product_details['category']['title']}}</a>
    ...
    <div class="row">
        <div id="gallery" class="span3">
            <a href="{{ asset('uploads/product_img_medium/' . $product_details['image']) }}" title="Blue Casual T-Shirt">
                <img src="{{ asset('uploads/product_img_medium/' . $product_details['image']) }}" style="width:100%" alt="Blue Casual T-Shirt">
            </a>
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <a href="{{ asset('uploads/product_img_medium/' . $image['images']) }}">
                            <img style="width:29%" src="{{ asset('uploads/product_img_small/' . $image['images']) }}" alt="">
                        </a>
                        @endforeach
                    </div>
                    <div class="item">
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h4 style="text-align:center">
                                            <a class="btn" href="{{ route('product.detail', $related_product['id']) }}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">BDT.{!! $related_product['price'] !!}</a>
                                        </h4>
                                    </div>
                                </div>
                            </li>
