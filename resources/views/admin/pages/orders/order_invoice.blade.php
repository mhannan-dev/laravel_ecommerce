...
<head>
    ...
    <title>Invoice for order number #1000{{ $orderDetails['id'] }}</title>
    ...
    <style>
        ...
        .barcode-main{position: relative;}
        .barcode{position: absolute;right: 0;}
        .invoice-date{margin-top: 40px;}
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">Barcode Information</th>
