        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('add.images',$product_data['id'])}}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <img style="height:150px;"
                                                src="{{ url('storage/product/'.$product_data['image']) }}"
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ route('edit_attribute', $product_data['id'])}}" method="post"> @csrf
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img style="height:150px;"
                                                src="{{ url('storage/multi_image/'.$prd_image['images']) }}">
                                        </td>
                                        <td>
                                            @if ($prd_image['status'] == 1 )
                                            <a prd_image_id="{{ $prd_image['id'] }}"
                                                class="prd_image_status text-success"
                                                id="product_{{ $prd_image['id'] }}" href="javascript:void(0)">
                                                Active
                                            </a>
                                            @else
                                            <a prd_image_id="{{ $prd_image['id'] }}" class="prd_image_status"
                                                id="prd_image_{{ $prd_image['id'] }}" href="javascript:void(0)">
                                                In Active
                                            </a>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{ route('delete_product_image', $prd_image['id']) }}"
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".prd_image_status").click(function () {
            ...
            $.ajax({
                type: 'post',
                url: '/admin/catalogue/update-product-image-status',
                data: {
                    status: status,
