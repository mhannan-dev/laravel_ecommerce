                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($product->status == 1)
                                                            <a product_id="{{ $product->id }}"
                                                                class="product_status text-success"
                                                                id="product_{{ $product->id }}"
                                                                href="javascript:void(0)"> Active
                                                            </a>
                                                        @else
                                                            <a product_id="{{ $product->id }}"
                                                                class="product_status text-danger"
                                                                id="product_{{ $product->id }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a title="Add Attributes"
                                                            href="{{ url('sadmin/add-product-attribute', $product->id) }}"
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).on("click", ".product_status", function() {
            ...
            $.ajax({
                type: 'post',
                url: '/sadmin/update-product-status',
                data: {
                    status: status,
