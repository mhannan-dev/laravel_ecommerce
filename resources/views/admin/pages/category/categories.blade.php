                                        ...
                                        @if (count($categories))
                                            @foreach ($categories as $key => $category)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($category->section) ? $category->section->title : '' }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($categoryModule['edit_access'] == 1 || $categoryModule['full_access'] == 1)
                                                            @if ($category->status == 1)
                                                                <a title="Change" category_id="{{ $category->id }}"
                                                                    class="text-success category_status"
                                                                    id="category_{{ $category->id }}"
                                                                    href="javascript:void(0)"> Active
                                                                </a>
                                                            @else
                                                                <a title="Change" category_id="{{ $category->id }}"
                                                                    class="category_status text-danger"
                                                                    id="category_{{ $category->id }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($categoryModule['full_access'] == 1)
                                                            <form style="display: inline-block"
                                                                action="{{ url('sadmin/category', $category->id) }}"
