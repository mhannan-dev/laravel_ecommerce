                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ url('sadmin/settings/change-password') }}">{{ $title }}</a>
                            </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ url('sadmin/update-current-pwd') }}" method="post">
                                @csrf
                                <div class="card-body">
