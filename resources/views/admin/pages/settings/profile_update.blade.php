                ...
                <div class="col-md-8">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal"
                            action="{{ route('profile_update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" class="form-control rounded-0"
                                            id="name" value="{{ Auth::guard('admin')->user()->name }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="mobile" class="col-sm-3 col-form-label">Mobile No</label>
                                    <div class="col-sm-10">
                        <input type="text" name="mobile" class="form-control rounded-0" id="mobile" value="{{ Auth::guard('admin')->user()->mobile }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                          ...
                                          <img style="width: 80px; height: 80px; margin-top:5px;" class="rounded float-right" src="{{ url('storage/admin/'.Auth::guard('admin')->user()->image) }}" alt="Admin Image">
                                          <input type="hidden" name="current_image" value="{{ !empty(Auth::guard('admin')->user()->image ) }}">
                                          @endif
                                    </div>
